...
<form:form name="fencing_form" autocomplete="off" action="match" method="POST" 
         ...
         <div class="card card-outline-secondary">
          ...
          <div id="select_graphic_options_div" style="display:none;">
			      ...
			      <div id="load_setup_match" class="panel-collapse collapse">
					<div class="panel-body">
					    ...
					    <div class="col-sm-8 col-md-8">
						    <label for="select_fencing_matches" class="col-sm-5 col-form-label text-left">Select Fencing Match</label>
						      <select id="select_fencing_matches" name="select_fencing_matches" 
		    ...
		    <div class="form-group row row-bottom-margin ml-2" style="margin-bottom:5px;">
			  ...
			  <div id="fencing_div" style="display:none;"></div>
           </div>
          </div>
         </div>
       </div>
